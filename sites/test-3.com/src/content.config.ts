...
// Keep this schema in sync with the `posts` collection in cloudcannon.config.yml.
...
const services = defineCollection({
  ...
  schema: object({
    ...
    // (CloudCannon always writes an object for every field group, and drops keys
...
// Keep in sync with the `locations` collection in cloudcannon.config.yml.
